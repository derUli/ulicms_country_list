INSERT INTO `{prefix}countries` (`countryCode`, `countryName`, `currencyCode`, `fipsCode`, `isoNumeric`, `north`, `south`, `east`, `west`, `capital`, `continentName`, `continent`, `languages`, `isoAlpha3`, `geonameId`) VALUES
...
('MD', 'Moldova', 'MDL', 'MD', '498', 48.490166, 45.468887, 30.135445, 26.618944, 'Chisinau', 'Europe', 'EU', 'ro,ru,gag,tr', 'MDA', 617790),
